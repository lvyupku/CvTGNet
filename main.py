...
from tools import load_checkpoint, save_checkpoint, get_grad_norm, auto_resume_helper, reduce_tensor
...
#     criterion = AUCM_MultiLabel(num_classes=config.MODEL.NUM_CLASSES)
